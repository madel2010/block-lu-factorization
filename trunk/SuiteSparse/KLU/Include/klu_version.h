...
////Start: Block Lu functions///////////
#elif defined BLOCKM
#define KLU_scale klu_B_scale
#define KLU_solve klu_B_solve
#define KLU_tsolve klu_B_tsolve
#define KLU_free_numeric klu_B_free_numeric
#define KLU_factor klu_B_factor
#define KLU_refactor klu_B_refactor
#define KLU_kernel_factor klu_B_kernel_factor 
#define KLU_lsolve klu_B_lsolve
#define KLU_ltsolve klu_B_ltsolve
#define KLU_usolve klu_B_usolve
#define KLU_utsolve klu_B_utsolve
#define KLU_kernel klu_B_kernel
#define KLU_valid klu_B_valid
#define KLU_valid_LU klu_B_valid_LU
#define KLU_sort klu_B_sort
#define KLU_rgrowth klu_B_rgrowth
#define KLU_rcond klu_B_rcond
#define KLU_extract klu_B_extract
#define KLU_condest klu_B_condest
...
#else
  #define KLU_numeric klu_B_numeric
#endif
...
////Start: Block Lu functions///////////
#ifdef BLOCKM
typedef BMatrix::MWrap<double> Unit ;
#define Entry BMatrix::MWrap<double>

#define SPLIT(s)                    (1)
#define REAL(c)                     (c.scalar)
#define IMAG(c)                     (0.)
#define ASSIGN(c,s1,s2,p,split)     { (c) = (s1)[p] ; }
#define CLEAR(c)                    { c.clear(); }
#define CLEAR_AND_INCREMENT(p)      { p++ = 0. ; }
#define IS_NAN(a)                   a.is_nan()
#define IS_ZERO(a)                  a.is_zero()
#define IS_NONZERO(a)               !a.is_zero();
...
#define APPROX_ABS(s,a)             { (s) = a.det() ; }
#define ABS(s,a)                    { (s) = a.det() ; }
#define PRINT_ENTRY(a)              {}
#define CONJ(a,x)                   a = x

/* for flop counts */
///TODO: calculate the number of flops effeciently 
